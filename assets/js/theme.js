jQuery(function ($) {
    ...
    function carousel() {
        ...
        $('.slider__body').owlCarousel({
            ...
            $('.slider__background--active').removeClass('slider__background--active');
            $('.slider__body .active').find('.slider__background').addClass('slider__background--active');
        });

        $('.slider__body .active').find('.slider__background').addClass('slider__background--active');
        $('.slider__body .owl-dots').addClass('slider__dot-container');
        $('.slider__body .owl-dot').addClass('slider__dot');

        $('.portfolio__body').owlCarousel({
            autoplay: false,
            loop: true,
            items: 4,
            autoplayHoverPause: true,
        ...
        $('.portfolio__body .owl-dots').addClass('portoflio__dot-container');
        $('.portfolio__body .owl-dot').addClass('portoflio__dot');


        $('.reference__body').owlCarousel({
            autoplay: true,
            loop: true,
            items: 1,
            autoplayHoverPause: true,
        ...
        $('.reference__body .owl-dots').addClass('reference__dot-container');
        $('.reference__body .owl-dot').addClass('reference__dot');
        ...
        $('.partners__body .owl-dots').addClass('partners__body-container');
        $('.partners__body .owl-dot').addClass('partners__body');
